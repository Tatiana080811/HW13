...
public class App {
    public static void main(String[] args) {
        ...
        searchables.add(new Article("Статья о яблоках", "Описание статьи о яблоках")); // Аналогично реализуем интерфейс Searchable в классе Article

        try {
            String searchQuery = "Яблоко";
            List<Searchable> foundItems = SearchEngine.findAllMatches(searchables, searchQuery); // Используем новый метод findAllMatches
